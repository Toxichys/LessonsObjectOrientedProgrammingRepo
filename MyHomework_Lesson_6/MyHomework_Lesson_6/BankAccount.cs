...
namespace MyHomework_Lesson_6
{
    ...
    class BankAccount
    {
        ...
        {
            if (value < 0) throw new ArgumentException("Отрицательная сумма пополнения");
            _balance += value;
        }
        /// <summary>
        ...
        {
            return bankAccountOne.Number == bankAccountTwo.Number;
        }
        ...
        {
            return bankAccount.Number == this.Number;
        }
        ...
        {
            return _number.ToString() + "/" + _typeBankAccount.ToString();
        }
